...
def test_shop_form(chrome_browser):
    ...
    chrome_browser.find_element(By.ID, "passwors").send_keys("secret_sauce")
    ...
    chrome_browser.find_element(By.ID, "postal-code").send_keys("123321")
